...
class Program
{
    ...
    static void ShowInterfacePolygon(IRegularPolygon polygon)
    {
    ...
    static void ShowAbstractPolygon(AbstractRegularPolygon polygon)
    {
        Console.WriteLine($"# of Sides:  {polygon.NumberOfSides}");
        Console.WriteLine($"Side Length: {polygon.SideLength}");
        Console.WriteLine($"Perimeter:   {polygon.Perimeter}");
    ...
    static void ShowDynamicPolygon(dynamic polygon)
    {
        Console.WriteLine($"# of Sides:  {polygon.NumberOfSides}");
        Console.WriteLine($"Side Length: {polygon.SideLength}");
